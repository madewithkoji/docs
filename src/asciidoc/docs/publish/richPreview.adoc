...
TIP: To improve the performance of your template, optimize your sharing image. For example, reduce the image size to 400x400 pixels, or load only the first frame of a gif.

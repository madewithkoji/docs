...
For example, to reduce the image size to 400x400 pixels and load only the first frame of a gif, you can add the query parameters `fit=bounds&width=400&height=400&frame=1` at the end of your image's URL: `https://images.koji-cdn.com/path/to/myimage.gif?fit=bounds&width=400&height=400&frame=1`

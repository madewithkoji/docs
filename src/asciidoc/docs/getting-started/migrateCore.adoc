...
This guide helps you migrate your code to the @withkoji/core package.

== Do I need to migrate?

You must migrate your code to the @withkoji/core package if you implemented features using one or more deprecated packages or if you forked a template or scaffold that uses them.

Your code uses one or more deprecated packages if any of the following is true:

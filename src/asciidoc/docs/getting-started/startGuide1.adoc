...
. To preview the template on the staging server before you publish it, you can click the remote staging button image:remote-staging.png[Remote staging button] in the preview pane to open the preview in a new tab.
. To preview the template on a mobile device, you can click the QR code button image:QRcode.png[QR code button] in the preview pane to display the QR code, then scan the code with your mobile device.
...
To see the results of the most recent profiling, from your live template, click the Koji button, and then click *More > Developer Tools*.
Select the attributes you want to see, such as *Content Audit* or *Entitlements*.
+

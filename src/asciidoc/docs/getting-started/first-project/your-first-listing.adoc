= Your first App Store listing
:page-slug: tutorial-first-app-listing
:page-description: Creating an App Store listing for your app
:includespath: ../../_includes

In the <<tutorial-first-app-contexts-customization#,previous topic>> of this tutorial, you created and published your first customizable app.

In this topic, you will
// tag::description[]
create a listing in the Koji App Store to showcase, market, and monetize your app.
// end::description[]

By making your app available in the Koji App Store, it becomes available:

* To all creators to add to their Koji profiles.
* To all developers to fork, if you enable forking.

You will learn how to:

[.singlespaced]
* Create a listing for the Koji App Store.
* Add metadata, including a description and other settings.
* Add marketing assets, including icons, screenshots, and videos.
* Link your app to your listing.
* Publish and update your listing.

...
* For creators, a new dashboard view provides access to information and settings for a Koji you create.
...
** Scrolling the home page no longer causes templates to load at the wrong scroll offset.

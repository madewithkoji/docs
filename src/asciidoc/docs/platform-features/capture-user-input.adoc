...
* Import @withkoji/core in your frontend code.
+
[source,javascript]
----
...
[.apiref]#<<core-frontend-ui-capture#audio,API reference>>#

** `.color` – Prompts the user to select or specify a color.
[.apiref]#<<core-frontend-ui-capture#color,API reference>>#
+
...
[.apiref]#<<core-frontend-ui-capture#video,API reference>>#

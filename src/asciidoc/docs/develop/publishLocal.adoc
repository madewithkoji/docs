...
=== Publishing your app as unlisted
...
Currently, this can only be done from the Koji editor, so you'll need to publish your app from there.

1. Follow the directions in <<_pulling_changes_into_the_koji_editor,Pulling changes into the Koji editor>>.
2. In the upper left of the Koji editor, click *Publish Now* to open the publish settings.
3. To publish your project as unlisted, select the *Unlisted* checkbox under *Discovery Options* near the bottom of the page.
+

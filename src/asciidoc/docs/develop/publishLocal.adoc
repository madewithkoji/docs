...
* Learn how to make and test changes locally.
* Learn how to push your changes to the origin repository, and then pull them into the Koji editor.
* Learn how to publish your changes to the Koji server.

...
As you develop and extend apps on Koji, you will likely encounter situations where it would be useful to put some of your code into a service. A common example is when you fork an app with a frontend, but you need to add a backend.
...
----
. Open the frontend/index.js file, update the config call as follows, and then save the file.
+
[source,javascript]
----
....

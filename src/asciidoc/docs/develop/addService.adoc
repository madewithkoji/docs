...
include::{includespath}/prereqs.adoc[tags=webdev;remixproc;customvcc]
...
. {blank}
include::{includespath}/remixNav.adoc[tag=all]
...
. In the preview pane on the right, click the remote staging button image:remote-preview.svg[Remote staging button] to open your template in a new browser tab.

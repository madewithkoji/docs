...
. Paste the following code into `package.json`, and save the file.
+
[source,json]
----
{
...
. Paste the following code into `.babelrc`, and save the file.
+
[source,json]
----
...
. Paste the following code into `server.js`, and save the file.
+
[source,javascript]
----

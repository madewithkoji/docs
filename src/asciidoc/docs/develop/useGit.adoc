...
+
The Repository Info tab shows links to two repositories.
+
image::remote-repository.png[Remote repository URL in the Koji editor]
...
. From any page on https://withkoji.com[withkoji.com], click your profile picture in the top right, and then click *Developer Portal*.
+
. Click *My Access Keys*.
. Click *Generate New Key* in the top right.
+

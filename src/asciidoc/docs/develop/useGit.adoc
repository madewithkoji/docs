...
:page-slug: use-git
:page-description: How to use Git to clone a Koji project app to your development machine, so that you can work on it locally.
:figure-caption!:
...
+
Koji stores each app and each remixed project as a separate Git repository.

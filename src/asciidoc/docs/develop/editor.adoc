...
Opening the code editor is different, depending on whether you're creating a new project or opening an existing one.


If you're creating a new project, you must set up a project and open it in the Koji code editor.

. Fork an existing project.
+
You can start from a https://withkoji.com/create/for-developers[developer scaffold] or from any Koji project that allows other developers to fork it.

include::{includespath}/steps-codeeditor.adoc[tag=open-in-code-editor]


If you're editing an existing project, open the associated project in the Koji code editor.
...
Learn more: <<testingTemplates.adoc#, Testing templates>>

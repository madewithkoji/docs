...
If your app includes different contexts or modes, you can select which context is displayed in the preview pane.
...
* The remote preview button image:{imagesDir}/remote-preview.svg[Remote preview button] opens a preview of your Koji in a new browser tab.

NOTE: The preview exists only as long as your code editor is active.
...
== Publishing your Koji

You can publish your Koji from the code editor.

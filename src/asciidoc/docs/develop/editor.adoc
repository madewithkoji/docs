...
IMPORTANT: If you made changes to your project files outside the Koji editor, you must <<publish-locally-developed#_updating_the_koji_code_editor_to_match_your_local_environment, update the project files>> before editing them in the code editor again.

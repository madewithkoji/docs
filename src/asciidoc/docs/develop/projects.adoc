...
For example, this app has directories for its backend and frontend services.
...
For example, this development configuration defines frontend and backend services.
...
If you provide configuration options for creators who use your app, the `@@initialTransform` key defines the placeholder values that override the default values when a creator first opens these settings.

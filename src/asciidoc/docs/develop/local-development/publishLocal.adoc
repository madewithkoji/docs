...
. On the https://withkoji.com/[Koji home page], click your profile button and go to *Apps > Developer Portal*.
...
[NOTE]
Koji provides tools for testing your app. For example, you can override the environment variables in the Koji debugger, so that you can use it for testing locally. See *Overriding settings for a debugging session* in <<testing-templates#,Testing and debugging apps>>.

...
You can use the <<_using_remote_preview,remote preview>> option to run the template in a new tab.
...
From the Koji editor, you can open the debugger by clicking *Launch Debugger* in the preview pane.

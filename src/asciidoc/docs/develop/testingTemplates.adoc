...
You can test *In-app purchases* by clicking *Debug in live player* on the *Remote* tab.

. First, make sure you've topped up your *Wallet* in *KojiPay*.
You'll use the Koji to send money to yourself, so you can issue yourself a refund when you finish testing.

. Open your Koji in *Debug in live player* and try paying yourself a small amount.
...
To test the autoplay feature, click *Debug in live player* to open the Koji in a new tab (see <<_previewing_the_koji>>).

...
The *Environment info* panel displays your templates's *App Id*, frame URL, and *VCC editor source*, and allows you to edit the frame URL.

By default, the debugger uses the VCC editor data from the live template.
You can override the live data by specifying different VCC editor data.
Click *Modify*, then select *Override and use different VCC editor data*.
The VCC editor data will be displayed in JSON format.
You directly modify the JSON to change the data.

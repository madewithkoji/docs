...
For more about contexts, see <<_using_live_previews>>.
...
You can view and modify environment information for your template, as well as settings and data for implemented features.

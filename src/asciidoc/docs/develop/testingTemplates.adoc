...
You should be able to use all the standard debugging tools that come with most code editors when working locally.
One tool that is always available is writing to the console.

...
Obviously, the available methods of testing locally will depend heavily on the development tools you are using, bne tool that is always available is writing to the console.

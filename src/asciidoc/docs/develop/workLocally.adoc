...
TIP: If your project includes a backend, you may find it necessary to set the environment variables every time you start up your code editor and before you launch your Koji. In this case, you may find it helpful to create batch files that run all the relevant commands.

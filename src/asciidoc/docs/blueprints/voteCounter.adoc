...
include::{includespath}/prereqs.adoc[tag=webdev;remixproc;backend;svcmap;kojidb]
...
* Multi-user experience – Use the remote staging button image:remote-staging.png[Remote staging button] in the preview pane to open the template in multiple tabs and ensure the vote counter remains synchronized.

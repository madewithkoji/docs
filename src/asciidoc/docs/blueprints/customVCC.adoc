...
include::{includespath}/prereqs.adoc[tag=webdev;3papi;remixproc;customvccopt]
...
. In your custom VCC project, click the remote staging button image:remote-staging.png[Remote staging button] in the preview pane to open a preview in a new tab.

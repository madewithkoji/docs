...
For example, you could point to a Koji with your bio, and then share or post the link everywhere.
If you ever want to update the bio or use a different Koji, you can change the link target in one place.
+

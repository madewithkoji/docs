...
The data includes standard, built-in metrics that are calculated from access logs.
* On the developer site, new content is available to help Koji developers get the most value from their templates, including <<template-versions#>>.

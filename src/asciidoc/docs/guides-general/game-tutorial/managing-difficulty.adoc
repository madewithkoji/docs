...
In the <<game-scoring-and-losing#, previous section>> of the remixable game tutorial, you made the game playable by adding ways to score and to lose.
...
In the <<game-remix#,next section>>, you'll take a look at the remix menu in the game template and make the game assets customizable.

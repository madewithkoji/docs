...
The https://withkoji.com/apps/78ddd0e8-de2d-498e-bd88-255166d54849[Game Template] is a great starting point for this project because it was created specifically for these types of hyper-casual games.
...
. Open the https://withkoji.com/apps/78ddd0e8-de2d-498e-bd88-255166d54849[game template] listing.
. Click menu:...[Fork].
+

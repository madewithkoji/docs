...
////
If you prefer to jump straight into code, you can head to the <<start-guide-1#,advanced quick start guide>>.
////
...
If you have any questions or feedback about this tutorial, please reach out to *@diddy* and the Koji community on https://discord.gg/kMkjJQ6Phb[Koji's Discord server].

...
:page-description: Learning about contexts
:figure-caption!:

In the last section of the Quick Start guide, we learned about remixing and some of the terms that we use to talk about Koji’s ecosystem.

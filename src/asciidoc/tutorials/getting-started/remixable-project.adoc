...
In the previous section of the Quick Start guide, we learned about contexts and how they help to deliver the remix experience that makes Koji such a powerful platform.
In this section, we dive into the things you need to do in the code to allow users to remix and publish their own customized versions of your project.
...
When a user remixes a template, the remix will load the same code that the template uses.

...
In the next section, we'll check for some collision between them in order to add some score, and also have the player lose a life in case a Collectible falls to the bottom without getting caught.
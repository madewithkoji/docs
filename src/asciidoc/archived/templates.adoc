...
You can use the editor to develop your template logic, or you can develop your template <<local-development#, in a remote editor>> and use the Koji editor for publishing and administration on the Koji platform.

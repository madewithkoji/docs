...
[source,json]
----
include::{includespath}/magazineCoverSettings.json[]
----
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=importPackages]
----
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=instantRemixing]
----
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=feedSdk]
----
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=monitorRemix]
----
.Vanilla JS
[source,javascript]
----
include::{includespath}/magazineCoverVanilla.js[tags=monitorRemix]
----
--
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=updateValues]
----
.Vanilla JS
[source,javascript]
----
include::{includespath}/magazineCoverVanilla.js[tags=updateValues]
----
--
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=optimizeImage]
----
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=clickHandlers]
----
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=dynamicSizing]
----
.Vanilla JS
[source,javascript]
----
include::{includespath}/magazineCoverVanilla.js[tags=dynamicSizing]
----
--
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=templateReady]
----
.Vanilla JS
[source,javascript]
----
include::{includespath}/magazineCoverVanilla.js[tags=templateReady]
----
--
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=renderTemplate]
----
.Vanilla JS
[source,javascript]
----
include::{includespath}/magazineCoverVanilla.js[tags=renderTemplate]
----
--
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=styles]
----
.Vanilla JS
[source,css]
----
include::{includespath}/magazineCoverVanilla.css[tags=styles]
----
--
...
[source,javascript]
----
include::{includespath}/magazineCoverReact.js[tags=**]
----
.Vanilla JS
====
[.tabs]
...
[source,javascript]
----
include::{includespath}/magazineCoverVanilla.js[tags=**]
----
.styles.css
[source,css]
----
include::{includespath}/magazineCoverVanilla.css[tags=**]
----
=====
====
--
